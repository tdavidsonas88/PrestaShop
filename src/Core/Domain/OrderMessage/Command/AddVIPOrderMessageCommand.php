 ...
 */
class AddVIPOrderMessageCommand extends AddOrderMessageCommand
{
    /**
     * @var string[]
     */
     ...
     * @param array $localizedVipOrderMessage
     *
     * @throws OrderMessageConstraintException
     */
    public function __construct(array $localizedName, array $localizedMessage, array $localizedVipOrderMessage)
    {
        ...
        $this->vipOrderMessage = $localizedVipOrderMessage;
    }
